...
\begin{figure}
\centering
\includegraphics[width=1\textwidth]{./images/04c_xgb_10_features_10k_cohort_actual_vs_modelled_subgroup_boxplot.jpg}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{./images/04c_xgb_10_features_10k_cohort_subgroup_correlation}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth]{./images/04c_xgb_10_features_10k_cohort_selected_subgroups}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth]{./images/04b_xgb_10_features_10k_cohort_selected_subgroups}
